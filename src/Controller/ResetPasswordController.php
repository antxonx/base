...
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData): RedirectResponse
    {
         ...
         * Formato del correo
         */
        $htmlMessage = $this->renderView("reset_password/email.html.twig", [
            'name' => $user->getName(),
        ...
        $mail->setFrom($_SERVER['RESET_PASSWORD_MAIL'], 'Restablecer contraseña');
        ...
        //     ->from(new Address('admin@userbase.com', 'Admin'))
        //     ->to($user->getMail())
