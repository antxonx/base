...
Encore
    ...
    .setPublicPath(ENV.parsed.PUBLIC_ROUTE) //colocar variable PUBLIC_ROUTE en .env
    ...
    .addEntry('user', './assets/js/user/index.ts')
    .addEntry('client', './assets/js/client/index.ts')
